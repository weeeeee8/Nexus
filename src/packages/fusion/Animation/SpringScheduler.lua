...
local packType = Aqua.Import(__FUSION_SRC_PATH__('/Animation/packType.lua'))
local springCoefficients = Aqua.Import(__FUSION_SRC_PATH__('/Animation/springCoefficients.lua'))
